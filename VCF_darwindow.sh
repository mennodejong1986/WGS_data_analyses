...
# Quick start guide for Heterozygostiy and ROH-analyses:
...
# 7. Execute the script on the Unix command line. This might take hours to days, depending on number of samples.
